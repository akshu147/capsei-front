    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          >
            Empower your team with AI-driven tools that accelerate development, enhance collaboration, and scale
            effortlessly. Ship faster, iterate smarter.
          </motion.p>
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-border text-foreground hover:bg-secondary px-8 py-6 text-base font-medium bg-transparent"
            >
              Login
            </Button>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">2,000+ teams trust NexusAI</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
